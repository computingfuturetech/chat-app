...
class Chatroom {
    ...
    factory Chatroom.fromJson(Map<String, dynamic> json) => Chatroom(
        ...
        membersInfo: json["members_info"] == null ? [] : List<MembersInfo>.from(json["members_info"]!.map((x) => MembersInfo.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "members_info": membersInfo == null ? [] : List<dynamic>.from(membersInfo!.map((x) => x.toJson())),
